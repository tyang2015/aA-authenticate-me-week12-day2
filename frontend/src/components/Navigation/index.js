  ...
  return (
    ...
    <div className='nav-bar-outer-container' style={{borderBottom:"1px solid rgba(177, 170, 170, 0.3)"}}>
      <ul className='top-nav-bar' style={{listStyle:'none'}}>
        ...
        <div className="search-query-box-outer-container">
          <div className='search-query-box-container'>
            <div className='search-query-text-box'>
              <h3>Anywhere&nbsp;|&nbsp;Price&nbsp;|&nbsp;Filter</h3>
            </div>
            {/* <span>
          ...
          <div className='search-button-outer-container'>
            <button className='search-button-container'>
              <svg className="magnifying-glass-icon"viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{}}><g fill="none"><path d="m13 24c6.0751322 0 11-4.9248678 11-11 0-6.07513225-4.9248678-11-11-11-6.07513225 0-11 4.92486775-11 11 0 6.0751322 4.92486775 11 11 11zm8-3 9 9"></path></g></svg>
            </button>
          </div>

        </div>
        <div className='top-right-nav-bar'>
          <div className='globe-icon' style={{marginRight:"20px"}}>
